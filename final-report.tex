...
From Figure 3.2 The Activity diagram shows the sequence how Generative AI for
...
Figure 3.10 represents the dashboard page, it will show all the form that user have and the add form section at the left hand side, also have a upload status while file is uploading.
...
Figure 3.10 represents the Edit Form. The edit form page uses the SurveyJS library, which allows users to fully customize a form, including changing the color, adding a second page, and creating form conditions.

\subsection{Form}

\begin{figure}[!h]
\centering
\fbox{\includegraphics[width= 10cm]{./assets/UI/.png}}
\caption{Edit Form Page}\label{fig:edit-form}
\end{figure}
